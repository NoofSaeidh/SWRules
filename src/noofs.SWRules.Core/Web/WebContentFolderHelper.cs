...
namespace noofs.SWRules.Web
{
    ...
    public static class WebContentDirectoryFinder
    {
        public static string CalculateContentRootFolder()
        {
            ...
            while (!DirectoryContains(directoryInfo.FullName, "noofs.SWRules.sln"))
            {
            ...
            return Path.Combine(directoryInfo.FullName, $"src{Path.DirectorySeparatorChar}noofs.SWRules.Web");
        }
